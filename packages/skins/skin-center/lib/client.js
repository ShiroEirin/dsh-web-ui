window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var skin_center_module_css_default = {
			...
			"wallpaperJumpInput": "eDzMgW_wallpaperJumpInput",
			"wallpaperName": "eDzMgW_wallpaperName",
			"wallpaperPageEllipsis": "eDzMgW_wallpaperPageEllipsis",
			"wallpaperPageNumber": "eDzMgW_wallpaperPageNumber",
			"wallpaperPageNumberActive": "eDzMgW_wallpaperPageNumberActive",
			"wallpaperPageNumbers": "eDzMgW_wallpaperPageNumbers",
			"wallpaperPager": "eDzMgW_wallpaperPager",
			"wallpaperPagerInfo": "eDzMgW_wallpaperPagerInfo",
			"wallpaperRatingBadge": "eDzMgW_wallpaperRatingBadge",
			"wallpaperRatingBadgeR18": "eDzMgW_wallpaperRatingBadgeR18",
			"wallpaperRatingTabs": "eDzMgW_wallpaperRatingTabs",
      ...
      `;
		...
		*/
		...
		function WallpaperPanel({ t, wallpaper }) {
			...
			const [rating, setRating] = (0, react.useState)("all");
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: skin_center_module_css_default.wallpaperRatingTabs,
						role: "group",
						"aria-label": t("wallpaperRating"),
						children: [
							"all",
							"G",
							"PG-13",
							...
							type: "button",
							className: skin_center_module_css_default.themeButton + (rating === value ? " " + skin_center_module_css_default.themeButtonActive : ""),
							"aria-pressed": rating === value,
							onClick: () => {
								setRating(value);
							},
							children: value === "all" ? t("wallpaperRatingAll") : value
						}, value))
					}),
					...
					items !== null && filtered.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											itemRating !== "G" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: skin_center_module_css_default.wallpaperRatingBadge + (itemRating === "R18" ? " " + skin_center_module_css_default.wallpaperRatingBadgeR18 : ""),
												children: itemRating
											}),
					...
					items !== null && items.length > 0 && filtered.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: skin_center_module_css_default.backgroundHintMuted,
						children: t("wallpaperRatingEmpty")
					}),
					items !== null && filtered.length > WALLPAPER_PAGE_SIZE && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: skin_center_module_css_default.wallpaperPageNumbers,
								children: pageNumbers(safePage, pageCount).map((value, index) => value === "…" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: skin_center_module_css_default.wallpaperPageEllipsis,
									"aria-hidden": "true",
									children: "…"
								}, "ellipsis" + index) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: skin_center_module_css_default.wallpaperPageNumber + (value === safePage ? " " + skin_center_module_css_default.wallpaperPageNumberActive : ""),
									"aria-current": value === safePage ? "page" : void 0,
									onClick: () => {
										setPage(value);
									},
									children: value
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: skin_center_module_css_default.wallpaperPagerInfo,
								children: [
									safePage,
									" / ",
									pageCount
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								className: skin_center_module_css_default.wallpaperJumpInput,
								type: "number",
								min: "1",
								max: pageCount,
								value: jumpInput,
